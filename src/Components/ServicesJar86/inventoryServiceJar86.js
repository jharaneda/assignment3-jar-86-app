...
return fetch("https://35.153.66.33:8000/cartJar86").then((response) =>
    response.json()
  );
}
...
return fetch("https://35.153.66.33:8000/inventoryJar86").then((response) =>
    response.json()
  );
}
...
return fetch("https://35.153.66.33:8000/cartJar86/totals").then((response) =>
    response.json()
  );
}
...
//   return fetch("http://localhost:8000/cartJar86", {
    return fetch("https://35.153.66.33:8000/cartJar86", {
    method: "POST",
...
//   return fetch("http://localhost:8000/cartJar86/checkout", {
    return fetch("https://35.153.66.33/cartJar86/checkout", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
  }).then((response) => response.json());
}
