...
return fetch("http://34.229.56.23:8000/cartJar86").then((response) =>
    response.json()
  );
}

export async function getInventory(newItem) {
return fetch("http://34.229.56.23:8000/inventoryJar86").then((response) =>
    response.json()
  );
}

export async function getTotals() {
return fetch("http://34.229.56.23:8000/cartJar86/totals").then((response) =>
    response.json()
  );
}
...
export async function addItemJar86(newItem) {
  const itemData = JSON.stringify(newItem);
    return fetch("http://34.229.56.23:8000/cartJar86", {
    method: "POST",
...
export async function checkout() {
    return fetch("http://34.229.56.23:8000/cartJar86/checkout", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
  }).then((response) => response.json());
}
